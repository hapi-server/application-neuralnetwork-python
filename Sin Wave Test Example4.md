...
```
    ...
    /home/jovyan/hapi_nn.py:125: UserWarning: Time gaps exist in the data.
      warnings.warn('Time gaps exist in the data.')
    /home/jovyan/hapi_nn.py:176: UserWarning: Removed data gab at index 0. Length of gab (10) was too small. Split size (1) is less than minimum step size (1536).
      warnings.warn(f'Removed data gab at index {ndx}. '
    /home/jovyan/hapi_nn.py:181: UserWarning: Data points with time gaps that caused too small of splits where removed. Removed 1 out of 2 gaps.
...
```
    ...
    /home/jovyan/hapi_nn.py:351: VisibleDeprecationWarning: Creating an ndarray from ragged nested sequences (which is a list-or-tuple of lists-or-tuples-or ndarrays with different lengths or shapes) is deprecated. If you meant to do this, you must specify 'dtype=object' when creating the ndarray.
      data = np.array(data)
    ...
    (0.6999379250021162, 0.19999435681837419, 0.1000677181795096)
...
```
    ...
    Epoch: 1/2 - Batch: 1219/1219 - Loss: 0.019433 - Validation Loss: 0.000006
    Epoch: 2/2 - Batch: 1219/1219 - Loss: 0.000188 - Validation Loss: 0.000007





    {'train': 4.736461242523073e-05,
     'val': 6.804186190757175e-06,
     'test': 3.3519199285669585e-06}
...
![png](Sin%20Wave%20Test%20Example_files/Sin%20Wave%20Test%20Example4_35_0.png)

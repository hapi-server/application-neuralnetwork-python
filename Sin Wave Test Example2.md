...
```
    ...
    (0.7001599606250769, 0.20004921865386982, 0.09979082072105327)
...
```
    ...
    2022-06-28 17:51:41.133149: I tensorflow/core/platform/cpu_feature_guard.cc:151] This TensorFlow binary is optimized with oneAPI Deep Neural Network Library (oneDNN) to use the following CPU instructions in performance-critical operations:  SSE4.1 SSE4.2 AVX AVX2 AVX512F FMA
...
```
    ...
    Epoch: 1/1 - Batch: 1779/1779 - Loss: 0.009468 - Validation Loss: 0.000000





    {'train': 2.7914615057525963e-06,
     'val': 4.0062109396997834e-07,
     'test': 1.998805418265335e-07}
...
![png](Sin%20Wave%20Test%20Example_files/Sin%20Wave%20Test%20Example2_35_0.png)
